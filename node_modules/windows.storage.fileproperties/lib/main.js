...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Storage_FileProperties.d.js)'))) {
    module.exports = require('./NodeRT_Windows_Storage_FileProperties.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Storage.Streams', 'Windows.Foundation'];
