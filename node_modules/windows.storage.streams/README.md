...
A Node.js wrapper for the <a href="http://msdn.microsoft.com/en-us/library/windows/apps/Windows.Storage.Streams.aspx" target="_blank">Windows.Storage.Streams</a> WinRT namespace, compatible with Windows 8.1.
