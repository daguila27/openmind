...
A Node.js wrapper for the <a href="http://msdn.microsoft.com/en-us/library/windows/apps/Windows.Foundation.aspx" target="_blank">Windows.Foundation</a> WinRT namespace, compatible with Windows 8.1.
