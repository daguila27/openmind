...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Storage_Provider.d.js)'))) {
    module.exports = require('./NodeRT_Windows_Storage_Provider.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Storage'];
