...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Storage_Search.d.js)'))) {
    module.exports = require('./NodeRT_Windows_Storage_Search.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.Storage.Streams', 'Windows.Storage', 'Windows.Storage.FileProperties'];
